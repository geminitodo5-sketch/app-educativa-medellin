// ─────────────────────────────────────────────────────────────
//  lib/ui/viewmodels/sociales_view_model.dart
// ─────────────────────────────────────────────────────────────
...
final socialesViewModelProvider =
    ChangeNotifierProvider<SocialesViewModel>((ref) {
  return SocialesViewModel(ref);
});

class SocialesViewModel extends ChangeNotifier {
  final Ref _ref;

  SocialesViewModel(this._ref);

  static const _materia = 'sociales';

  /// Héroes de la Ciudad, Detective de Objetos, Pasado y Presente
  ...
  Future<void> commandSeleccionarTema(String nombre,
  ...
  void commandVolver() => debugPrint('Sociales: volver');
}
