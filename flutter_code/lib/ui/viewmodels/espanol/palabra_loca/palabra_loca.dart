...
class _ArmaLaPalabraScreenState extends ConsumerState<ArmaLaPalabraScreen>
  ...
  void initState() {
    ...
    // Shake: oscila de -8 a +8 px tres veces
  ...
  Widget build(BuildContext context) {
    ...
    // Lanzar animaciones según cambios de estado
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                            ...
                            // Recuadros con animación shake en error
                            AnimatedBuilder(
                    ...
                    // Grid de sílabas / botón siguiente
                    if (state.completado)
                      _BotonSiguiente(
                        onTap: () {
                          _successController.reset();
...
/// Recuadros de respuesta — con onQuitarSilaba y estados de error/éxito
class _RecuadrosRespuesta extends StatelessWidget {
  ...
  /// Nuevo: devuelve la sílaba del recuadro [i] al pool
          ...
          child: DragTarget<int>(
            ...
            builder: (context, candidateData, rejectedData) {
              ...
              return GestureDetector(
                // Tap en recuadro lleno → devolver al pool
                  ...
                  child: estaLleno
                      ? Stack(
                          ...
                          children: [
                            ...
                            // Botoncito "×" visible solo cuando se puede quitar
                            if (!completado && !error)
                              Positioned(
                                top: -4,
                                right: -4,
...
/// Banner rojo de error con botón reintentar
